...
if ((_bot_info[? "username"] == undefined) && (_bot_info[? "avatar_url"] == undefined))  {
	show_debug_message("DHOOK WARNING: " + "Discord Webhook is missing bot information. Will execute as default.");
}

if (_bot_info[? "content"] == undefined) && (_bot_info[? "embeds"] == undefined) {
	show_debug_message("DHOOK ERROR: " + "Discord Webhook has no message. Please set a message.");
	return -1;	
}
